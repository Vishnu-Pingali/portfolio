    ...
    <section id="hero" className="relative h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 pt-20 flex flex-col items-center">
        ...
        <motion.p 
          ...
          className="relative z-10 text-sm md:text-base text-white max-w-2xl mx-auto mb-10 font-mono tracking-widest leading-relaxed bg-base/50 p-4 border-l-2 border-accent-primary"
        >
